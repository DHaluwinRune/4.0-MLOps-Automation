...
def main():
    ...
    opt = tf.keras.optimizers.SGD(
        learning_rate=lr_schedule, momentum=0.0, nesterov=False  # if you need momentum
    )
    ...
    print(
        f"Using steps_per_epoch={steps_per_epoch}, batch_size={BATCH_SIZE}, train_samples={len(X_train)}"
    )
    ...
    # Save the confusion matrix to the outputs folder of the component
